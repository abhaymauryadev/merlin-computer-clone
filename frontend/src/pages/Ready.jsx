...
const Ready = () => {
  return (
    <section className='bg-[linear-gradient(180deg,_#fff,_#fff_58.17%,_#e1f2e6)] max-w-6xl m-auto  lg:min-h-[700px] mt-20 md:mt-60 mb-20 md:mb-60 pt-4 rounded-4xl px-4'>
        <div className='relative'>
         ...
         <div className='flex justify-between items-center mt-16 md:mt-20 max-w-xl m-auto px-4'>
              <h1 className='font-semibold text-center text-3xl md:text-5xl'>Ready to win back 12 hours a week?</h1>
          </div>
          ...
          <div className='flex flex-col md:flex-row justify-center items-center mt-12 md:mt-16 gap-8 md:gap-30 max-w-6xl m-auto md:space-x-7'>
              <div className='flex flex-col items-center text-center gap-4 max-w-sm'>
                ...
                <h1 className='text-center text-xl md:text-2xl'>Connect in minutes</h1>
