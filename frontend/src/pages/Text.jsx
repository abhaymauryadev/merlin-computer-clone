...
const Text = () => {
  ...
  return (
    <section className="bg-[#ffff] lg:max-w-[800px] m-auto mt-70 mb-70">
      {/* Quote */}
      <div ref={quoteRef} className="flex justify-center  items-center text-[28px]  lg:text-[40px] lg:leading-[45px] font-medium">
